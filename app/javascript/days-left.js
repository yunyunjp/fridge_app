window.addEventListener('load', () => {
  ...
  for (let i = 0; i < arrjsonInput.value ; i++) {
    ...
    if (daysLeft.innerHTML <= 0) {
     ...
     deadLine.setAttribute("style", "color:#7945F5;text-decoration:underline;text-decoration-color:#7945F5;");
     daysLeft.setAttribute("style", "color:#7945F5;text-decoration:underline;text-decoration-color:#7945F5;");
